...
import com.zhou.common.utils.FastDFSClient;
...
public class FastDfsTest {
	...
	public void testUpload() throws Exception {
		...
		//使用全局对象加载配置文件。
		ClientGlobal.init("C:/Users/Administrator/workspace/shop-manager-web/src/main/resources/conf/client.conf");
		//创建一个TrackerClient对象
